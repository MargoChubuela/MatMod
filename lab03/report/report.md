...
subtitle: "Модель боевых действий - вариант 55"
...
```
x0 = 65300;//численность первой армии
y0 = 55500;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.67;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.54;//эффективность боевых действий армии у
c = 0.491;//эффективность боевых действий армии х
h = 0.37;//константа, характеризующая степень влияния различных факторов на потери армии у
...
y0 = 55500;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.278;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.701;//эффективность боевых действий армии у
c = 0.502;//эффективность боевых действий армии х
h = 0.188;//константа, характеризующая степень влияния различных факторов на потери армии у
tmax = 1;//предельный момент времени
dt = 0.05;//шаг изменения времени
t = [t0:dt:tmax];
function p=P(t)//возможность подхода подкрепления к армии х
