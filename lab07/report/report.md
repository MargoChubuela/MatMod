...
subtitle: "Модель распространения рекламы - вариант 55"
...
def a1(t): 
    a1 = 0.58*math.cos(2*t)
    return a1

def a2(t): 
    a2 = 0.38*math.cos(3*t)
    return a2

t = np.arange( t0, 0.05, 0.001)
...
максимальная скорость распространения достигается при $t=0.005$
